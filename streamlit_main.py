...
def show_dynamic_simulation_page():
    ...
    def run_and_store_model5_scenario2_results():
        ...
        T_START_SIM = params_s2.get('t₀', 0.0); SOLVER_MAX_DURATION_GUESS = 70.0 
        T_END_SIM_S2 = T_START_SIM + SOLVER_MAX_DURATION_GUESS
        AVOIDANCE_RADIUS_SIM = INITIAL_DISTANCE_D_SIM * 0.40
        AVOIDANCE_STRENGTH_FACTOR_SIM = 1.1; CATCH_THRESHOLD_SIM = 0.75
        ...
        st.session_state.m5s2_params = {
            ...
            'v_tn_max': V_TN_MAX_SIM, 't_start': T_START_SIM, 't_end': T_END_SIM_S2, 
            'simulation_duration': SOLVER_MAX_DURATION_GUESS,
            'method_short': st.session_state.dynamic_plot_data.get('method_short', 'Bashforth'),
            'method_steps': st.session_state.dynamic_plot_data.get('method_steps', 4),
            'avoidance_radius': AVOIDANCE_RADIUS_SIM, 'avoidance_strength': AVOIDANCE_STRENGTH_FACTOR_SIM,
            'fov_tn_degrees': FIELD_OF_VIEW_TN_DEGREES_SIM, 'kt_radar_radius': KT_RADAR_RADIUS_SIM,
            'min_time_free_turn': MIN_TIME_BETWEEN_FREE_TURNS_TN_SIM, 'max_angle_free_turn_rad': FREE_TURN_ANGLE_MAX_RAD_TN_SIM,
        ...
        st.session_state.m5s2_trajectory_params = {"offset_x": offset_x_tn, "offset_y": offset_y_tn, "params_x": params_x_tn, "params_y": params_y_tn}
        ...
        solver_func = solver_map.get(method_short, {}).get(method_steps, AB4_system_M5_Sim2_CombinedLogic)
        ...
        # Gọi hàm solver
        t_points, state_hist, caught, t_catch = solver_func(
            f_combined_like=_m5_sim2_combined_ode,
            t_array_full_potential=t_array_solver,
            initial_state_combined=initial_state,
            catch_dist_threshold=st.session_state.m5s2_params['catch_threshold']
        )
        st.session_state.m5s2_results = { "time_points": t_points, "state_history": state_hist, "caught": caught, "time_of_catch": t_catch }
    # ==============================================
